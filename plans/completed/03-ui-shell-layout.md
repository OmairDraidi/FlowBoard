...
- [x] Layout renders with 3 regions (sidebar, header, main)
- [x] Board list in sidebar, clicking switches active board
- [x] Theme toggle works and persists
- [x] Modal opens/closes with backdrop
- [x] ConfirmDialog works for destructive actions
